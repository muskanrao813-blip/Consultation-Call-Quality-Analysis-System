...
export default function DashboardView({
  ...
  // Stats calculations
  const totalCalls = 12482; // Static large number matching screenshot
  const avgQualityScore = 94.2;
  const sopCompliance = 88.5;
  const criticalAlertsCount = 14;
  ...
  // Mock data for the dietician distribution bars
  const performanceDist = [
    { name: 'Vance', score: 98, peerMedian: 85 },
    { name: 'Sterling', score: 64, peerMedian: 85 },
    { name: 'Wu', score: 91, peerMedian: 85 },
    { name: 'Chen', score: 82, peerMedian: 85 },
    { name: 'Patel', score: 89, peerMedian: 85 },
    { name: 'Gomez', score: 91, peerMedian: 85 },
  ];
